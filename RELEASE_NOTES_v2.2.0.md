...
We are excited to announce **OCT Skin Layer Analyzer v2.2.0**! This update strictly preserves 100% of the original legacy folder conventions (Richard V1 pipeline) while adding multi-level tree discovery, optional dual-save mirrored exports, regularized spike-free Epidermal-Dermal Junction (`end ED`) boundary extraction, and native Windows 10/11 UI compatibility.

---

## 🌟 What's New in v2.2.0

### 1. 🎯 100% Legacy Pipeline Compatibility (Richard V1 Preserved)
...
### 2. 🌲 Universal Multi-Scale Top Folder Crawler
...
### 3. 🛡️ Robust & Spike-Free Epidermis (`end ED` / DEJ) Boundary Extraction
...
### 4. 🖥️ Modern Responsive UI (Windows 10 & 11 Native)
